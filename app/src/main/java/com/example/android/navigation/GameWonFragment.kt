...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(context,"Num Correct: ${args.numCorrect}, NumQuestions: ${args.numQuestions}", Toast.LENGTH_LONG).show()
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        //check if activity resolves, otherwise hide the share menu
    ...
    private fun getShareIntent() : Intent {
        val args = GameWonFragmentArgs.fromBundle(requireArguments())
//        Can also use for non fragments
//        return ShareCompat.IntentBuilder.from(activity)
//                .setText(getString(R.string.share_success_text,args.numCorrect, args.numQuestions))
//                .setType("text/plain").intent
//        can remove the type in case no apps are found to share
